...
INSERT INTO `roadtrips`(image_url, title, countries, description, done, user_id) 
	...
	("https://images.unsplash.com/photo-1668246629236-23299fa1e6a8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mzl8fGNvdW50cmllcyUyMGltYWdlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60", "In Sweden we connected with nature", "Sweden", "We dove to these stops and we recommend it if you travel with kids", 3, 1),
	...
	("https://images.unsplash.com/photo-1666684994238-624f2cfccad6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDZ8fGNvdW50eSUyMHNpZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60", "For architecture fanatics", "France", "Me and my partner had a great time at this roadtrip!", 3, 1),

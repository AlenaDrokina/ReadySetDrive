...
INSERT INTO roadtrips(image_url, title, countries, description, done, user_id) 
    VALUES ("test.jpg", "My roadtrip in Spain", "Spain", "I did a roundtrip in Andalucia...", 1, 1), 
    ("test.jpg", "My roadtrip in Portugal", "Portugal", "I did a roundtrip from Porto to Lisbon", 1, 1), 
    ("test.jpg", "My roadtrip in France", "France", "I did a roundtrip in Normandy", 1, 2), 
    ("test.jpg", "My roadtrip in France", "France", "I did a roundtrip from Paris to Marseille", 1, 2); 
